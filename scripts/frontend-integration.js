 ...
 * This file demonstrates how to integrate Chainxeno with a web frontend
 */

// For React/Vue/Angular applications
export class ChainxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChainxenoClient(provider, contractAddress);
